...
function OutputToExcel() {
	document.forms["studentInfoQueryForm"].action = "/controller/StudentInfoAction.php?action=OutToExcel";
	document.forms["studentInfoQueryForm"].submit(); 
}

function Submit() {
	document.forms["studentInfoQueryForm"].action = "/controller/StudentInfoAction.php?action=query";
	document.forms["studentInfoQueryForm"].submit(); 	
}
</script>
...
<body>
	<div id="container">
			...
			<table width="98%" border="0" cellpadding="0" cellspacing="2" align="center">
				<tr>
					<td height="21"><img src="../images/ico/ico08.gif" alt="" />
						<strong>学生信息管理</strong><script type="text/javascript">writeSpaces(105);</script>
		...
		<div id="content">
			<form id="studentInfoQueryForm" name="studentInfoQueryForm" onsubmit="Submit();"   method="post">
				<!--startprint-->
				<table width="98%" border="1" cellspacing="1" cellpadding="2" align="center" style="margin: 0px;">
					<tr>
						<td colspan="9">
							...
							<br/>户口所在地: <input class="text" type="text" style="width: 100px" value="<?php echo $hkszd?>" name="hkszd" />
							家庭地址: <input class="text" type="text" style="width: 150px" value="<?php echo $address?>" name="address" />
							...
							<input type="button" class="btn" value="查询" onClick="Submit();" />
...
for($i = 0; $i < count ( $fenyePage->res_array ); $i ++) {
	...
	echo "<td><div align='left'><a href='#' onclick=\"OpenEditStudentInfo('{$row['zkzh']}', '修改学生信息','{$row['zkzh']}');\">修改</a>&nbsp;&nbsp;</div><div align=\"right\"><a href='StudentInfoAction.php?action=del&zkzh={$row['zkzh']}' onclick=\"return confirm('警告：您确认删除吗？');\">删除</a></div></td>";
	echo "</tr>";
}
