//var IMGFOLDERPATH = 'http://www.5-studio.com/wp-content/uploads/2009/06/';//图片路径配置
var IMGFOLDERPATH = 'http://www.studentsystem.com/opennew/images/'; //图片路径配置
...
if ( !this.ParentWindow ){
	...
	arr.push("           	<input id='_ButtonOK_"+this.ID+"'  type='button' value='确 定' style='display:none'>");
	arr.push("           	<input id='_ButtonCancel_"+this.ID+"'  type='button' onclick=\"Dialog.getInstance('"+this.ID+"').close();\" value='关 闭'  >");
	arr.push("            </div></td></tr>");
...
Dialog.prototype.close = function(){
	...
	if(this.WindowFlag){
		...
		pw.frames[0].document.getElementById("Ajax_Btn").click();
